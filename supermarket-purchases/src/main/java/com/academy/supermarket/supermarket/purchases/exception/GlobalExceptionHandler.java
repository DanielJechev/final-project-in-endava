...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> bookAlreadyExists(SuperMarketAlreadyExistsException superMarketAlreadyExistsException) {
    ...
    public ResponseEntity<Object> bookNotFound(SuperMarketNotFoundException superMarketNotFoundException) {
